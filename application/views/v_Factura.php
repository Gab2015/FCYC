				...
				<div class="col-lg-5 col-xs-11 well">
					<fieldset>
						...
						<div class="form-group">
							<div class="row colbox">
								<div class="col-lg-4 col-xs-12">
									<label for="txt_DocType" class="control-lable">Tipo</label>
								</div>
								<div class="col-lg-6 col-xs-12">
									<input class="form-control" id="txt_DocType" name="txt_DocType" placeholder="Articulo o Servicio" type="text" value="<?php echo set_value('txt_DocType'); ?>"/>
					...
					<fieldset>
						<div class="form-group">
							<div class="row colbox">
								<div class="col-lg-4 col-xs-12">
									<label for="txt_IdTipo" class="control-label">Tipo Documento</label>
								</div>
								<div class="col-lg-6 col-xs-12">
									<input class="form-control" id="txt_IdTipo" name="txt_IdTipo" placeholder="Tipo Documento" type="text" value="<?php echo set_value('txt_IdTipo'); ?>" />
						...
						<div class="form-group">
							<div class="row colbox">
								<div class="col-lg-4 col-xs-12">
									<label for="txt_FechaContable" class="control-lable">Fecha Contable</label>
								</div>
								<div class="col-lg-6 col-xs-12">
									<input class="form-control" id="txt_FechaContable" name="txt_FechaContable" placeholder="Fecha Contable" type="text" value="<?php echo set_value('txt_FechaContable'); ?>"/>
