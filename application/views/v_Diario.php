	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-xs-11">
				...
				<span style="float:left"><a id ="diario" class="btn btn-success" href="<?php echo base_url('');?>diario.php?Imprimir=true&vNumDoc=<?php echo $filaDiario->NumDoc;?>&vNumCaja=" target="_blank"><span id="Herramienta" class="glyphicon glyphicon-print"></span> Imprimir</a>&nbsp;</span>	 		
			</div>
		</div>
		<?php
	}
